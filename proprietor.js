...
router.post('/fetch',(req,res)=>{
  ...
  pool.query(`SELECT rentalapp.rent.* FROM rentalapp.rent inner join rentalapp.ownto on rentalapp.rent.id = rentalapp.ownto.id And rentalapp.ownto.owner = "${owner}" inner join rentalapp.to_rent on rentalapp.rent.id = rentalapp.to_rent.id;`)
  .then((row)=>{
    res.json({apt : row})})
})
